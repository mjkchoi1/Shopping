...
<div class="container-fluid">
    ...
    <?php if (!in_array($column["Field"], $ignore)) : ?>
        <div class="mb-4">
            <label class="form-label" for="<?php echo $column["Field"]; ?>"><?php echo $column["Field"]; ?></label>
            <input class="form-control" id="<?php echo $column["Field"]; ?>" type="<?php echo input_map($column["Type"]); ?>" name="<?php echo $column["Field"]; ?>" />
        </div>
    <?php endif; ?>
<?php endforeach; ?>
