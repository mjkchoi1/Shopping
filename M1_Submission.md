...
<tr><td> <em>Generated: </em> 2/3/2023 3:37:36 PM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-008-S23/it202-m1-gettingstarted/grade/mjc" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/116091558/215222879-f82fd03b-8039-4ca4-8388-d6e7dcc89772.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>I have installed WakaTime, MySQL, and PHP on VS Code. <br></p>
</td></tr>
</table></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/116091558/215223123-121d8916-86d4-4601-a30a-e2fc75e8675b.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>I have set up my database from my IDE MySQL extension<br></p>
</td></tr>
</table></td></tr>
</table></td></tr>
...
<tr><td> <em>Response:</em> <p>I kept having trouble with cloning, pushing, and basically that connects to the<br>remote. I have had the problem during class. It continued until just now<br>even though I checked that cloning worked, and I have added all the<br>right keys. I found out that my computer is a bit special, and<br>I have to run the eval code and add the key every single<br>time that I restart Git Bash using ssh-add command. I had to make<br>a lot of keys to figure out what the problem was. I felt<br>the pain of locksmith, but I was luckily able to figure it out.<br></p><br></td></tr>
</table></td></tr>
...
<tr><td> <em>Response:</em> <p>As I mentioned in the previous question, I had a lot of trouble<br>setting up and connecting my Github account to my device. The problem was<br>solved after I ran the eval and ssh-add command every time.<br></p><br></td></tr>
</table></td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/mjkchoi1/IT202-008/pull/1">https://github.com/mjkchoi1/IT202-008/pull/1</a> </td></tr>
</table></td></tr>
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-008-S23/it202-m1-gettingstarted/grade/mjc" target="_blank">Grading</a></td></tr></table>
